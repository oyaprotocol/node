...
-- Create the vaults table (maps vault IDs to their controllers)
...
export async function setupDatabase(options) {
	...
	try {
		...
		if (dropExisting) {
            ...
            console.log(chalk.red('  - bundles, cids, balances, proposers, vaults, deposits, deposit_assignment_events'))
